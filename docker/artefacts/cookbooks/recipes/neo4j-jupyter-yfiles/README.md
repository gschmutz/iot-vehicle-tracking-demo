...
Navigate to <http://172.20.10.3:7474> and login as user `neo4j` and password `abc123abc123`.
...
Navigate to <http://172.20.10.3:28888> and login with the token specified above, i.e. `abc123!`.
