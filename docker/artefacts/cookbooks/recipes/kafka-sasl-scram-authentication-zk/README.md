...
Navigate to AKHQ on <http://172.20.10.3:28107>.

## KaDeck

Navigate to KaDeck on <http://172.20.10.3:28313>, login as user `admin` with password `admin` and accept the license information.
