...
Navigate to <http://:8161> for the ActiveMQ dashboard.

To manage the ActiveMQ server, navigate to <http://:8161/admin/> and use `admin` for the user and `admin` for the password when asked for.